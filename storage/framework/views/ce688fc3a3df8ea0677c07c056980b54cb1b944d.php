        ...
        <nav class="dashboard__nav-list">
            <ul class="dashboard__nav-items">
                <li class="dashboard__nav-item dashboard__nav-item-active">
                    <a href="<?php echo e(route('admin.pages.list')); ?>"><img class="svg" src="/images/home-icon.svg" alt="Главная">Главная</a>
                </li>
                <li class="dashboard__nav-item">
                    <a href="<?php echo e(route('admin.pages.list')); ?>"><img class="svg" src="/images/pages-icon.svg" alt="Страницы сайта">Страницы сайта</a>
                </li>
                <li class="dashboard__nav-item">
...
<?php echo $__env->yieldContent('dashboard_js'); ?>
</body>
</html>
<?php /**PATH /home/primus/prj/teach/resources/views/admin/layouts/main.blade.php ENDPATH**/ ?>